...
/**
 * Classe de récupération des oncles communs de deux noeuds
 * @author Paul Pidou
 */
public class GetCommonUncles implements CommandLine.ICommand {
	public boolean doIt(Vector v) {
		...
		myDisplay.asyncExec(new Runnable() {
			public void run() {
				...
				grapher.getCommonUncles(node1, node2);
				grapher.showGraph();
			}
		});
		return true;
